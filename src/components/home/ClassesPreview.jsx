...
},
{
  ...
  features: ['Positional analysis', 'Timed games & puzzles', 'Advanced concepts', 'Psychological resilience'],
    ...
    <section className="bg-[#0A0A0A] py-28 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row gap-0 border border-[#D4A843]/20 overflow-hidden">
          ...
          {/* Content */}
          <div className="flex-1 bg-[#111111] p-8 lg:p-12">
            <motion.div
              key={active}
              ...
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <div className="font-lato text-[#D4A843]/50 text-xs tracking-widest uppercase">{phases[active].tagline}</div>
                    <div className="font-oswald text-white text-2xl uppercase tracking-wide">{phases[active].title}</div>
                  </div>
                </div>

...
export default function BeginningCTA() {
  return (
    <section className="bg-[#E8A020] py-20">
      <motion.div
      ...
      >
        <h2 className="font-fredoka text-white" style={{ fontSize: 'clamp(1.8rem, 3.5vw, 2.6rem)' }}>
        ...
        <MotionLink
          ...
          className="group inline-flex items-center gap-2 bg-white text-[#E8A020] font-fredoka font-600 text-sm px-6 py-3.5 rounded-2xl hover:bg-[#fdf6e8] transition-all hover:shadow-lg hover:shadow-black/10"
        >
          Get in Touch

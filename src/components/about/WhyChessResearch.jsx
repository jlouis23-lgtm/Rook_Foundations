      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        >
          ...
          <p className="font-nunito text-[#2D2520]/65 text-sm leading-relaxed">
            Instead, our aim is to create an engaging thinking environment where children develop <span className="text-[#E8A020] font-700">focus, reasoning, patience, and discipline</span>. It is our goal that, over time, the principles they learn with us will support broader learning and extend positively into other areas of life.
          </p>

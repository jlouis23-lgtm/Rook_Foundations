...
{ label: 'Our Community', path: '/testimonials' },
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <a href="tel:+1234567890" className="font-lato text-white/70 hover:text-[#D4A843] transition-colors text-sm">+44 7707 267563
            ...
            <Link to="/contact" className="inline-block mt-8 bg-[#D4A843] text-[#0A0A0A] font-oswald font-600 text-sm tracking-wider px-6 py-3 hover:bg-[#e8c06a] transition-all">

...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes, and this is something I care deeply about. Chess naturally provides structure, clear rules, and consistent patterns — things that many autistic children find reassuring and engaging. That said, playing a game with someone sitting opposite you can involve real social and emotional demands, and I understand that this may feel stressful or unfamiliar, particularly when working with someone new. Many autistic children also experience anxiety around social environments, which can affect their confidence and opportunities over time. Through my studies and professional experience, I have developed a deeper understanding of how to create emotionally safe, lower-pressure learning environments. I adapt my teaching approach for each child — which may include a greater focus on computer-assisted instruction, which is already built into my lesson plans and can help reduce sensory demands and provide clearer visual cues. Before lessons begin, I always encourage parents to get in touch so I can learn about their child's individual needs, including communication style, sensory sensitivities, anxiety levels, and learning preferences. This helps me plan sessions that feel supportive and meaningful from the very start."
  },
  {
  ...
  },
  {
    ...
    a: "Absolutely. Chess is for anyone who enjoys thinking creatively, solving problems, and learning new skills. Although chess has historically been male-dominated, many women and girls have shown that talent, dedication, and hard work matter far more than gender. A famous example is Judit Polgár, widely regarded as the strongest female chess player in history — she defeated several world champions, including Garry Kasparov, at a time when many still underestimated women in chess. Chess can be a fantastic activity for girls, helping to build confidence, resilience, concentration, and independent thinking in a supportive environment. My teaching approach is fully inclusive, and lessons are adapted to each child's personality, interests, and learning style so they can feel comfortable, engaged, and capable from the very beginning."
  },
  {

...
const phases = [
  {
    ...
    parentNote: 'Children at this age learn through play — expect laughter, stories about the "castle" and the "horse," and genuine excitement at each new discovery. Every child develops at their own pace, and that is something we fully embrace. Some children will grasp concepts quickly; others may need repetition, forget things between sessions, or take longer to build confidence — all of this is completely normal and expected. Lessons are intentionally shaped around each child\'s current level of understanding, attention span, and learning style. Guided by the idea that children grow best when gently stretched just beyond what they can already do, sessions are designed to build on prior understanding one small step at a time. Detailed notes are kept after every session to track progress and ensure no child is ever pushed ahead before they are ready. The focus is always on patience, encouragement, and building a love of thinking — not on how fast a child progresses.',
  },
  {

...
import {
  ArrowLeft, ArrowRight, Lock, Mail, Phone, Globe, User2, MessageCircle,
} from 'lucide-react';
      ...
      <section className="relative overflow-hidden py-16">
        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-12 relative z-10">
          ...
          <p className="font-nunito text-[#2D2520]/60 text-lg leading-relaxed max-w-2xl mb-4">
            How Rook Foundations collects, uses and protects personal information
          </p>
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 font-nunito text-[#2D2520]/40 text-sm">
            <span>{privacyMeta.version}</span>
            <span aria-hidden="true">·</span>
            <span>{privacyMeta.lastUpdated}</span>
          </div>
        </div>
      </section>
